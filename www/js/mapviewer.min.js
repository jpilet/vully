...
for(var i=0;i<container.childNodes.length;++i){var child=container.childNodes[i];if("hasAttribute"in child&&(child.hasAttribute("data-map-pos")||child.hasAttribute("data-map-geo"))){if(child.hasAttribute("data-map-pos")){var pos=splitArrayArg(child.getAttribute("data-map-pos"));}else{var geopos=splitArrayArg(child.getAttribute("data-map-geo"));var pos=canvasTilesRenderer.params.geoConv(geopos[0],geopos[1]);}
